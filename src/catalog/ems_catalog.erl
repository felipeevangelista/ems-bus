...
new_service_re(Rowid, Id, Name, Url, Service, ModuleName, ModuleNameCanonical, FunctionName, 
			   ...
			   ServiceResendMsg1, ServiceResendMsg2, ServiceResendMsg3, 
...
new_from_map(Map, Conf = #config{cat_enable_services = EnableServices,
	...
	try
		...
		ServiceResendMsg2 = list_to_atom("service_" ++ integer_to_list(Rowid) ++ "_resend_msg2"),
		ServiceResendMsg3 = list_to_atom("service_" ++ integer_to_list(Rowid) ++ "_resend_msg3"),
		case UseRE of
			true -> 
