...
start(_StartType, StartArgs) ->
	...
	case ems_config:start() of
		{ok, _Pid} ->
			...
			ems_logger:info("  \033[0;32mlog_show_response_max_length\033[0m: \033[01;34m~p bytes (~s)\033[0m.", [Conf#config.log_show_response_max_length, ems_util:bytes_to_human_size(Conf#config.log_show_response_max_length)]),
			ems_logger:info("  \033[0;32mlog_show_payload_max_length\033[0m: \033[01;34m~p bytes (~s)\033[0m.", [Conf#config.log_show_payload_max_length, ems_util:bytes_to_human_size(Conf#config.log_show_payload_max_length)]),
			...
			ems_logger:info("  \033[0;32mlog_file_max_size\033[0m: \033[01;34m~p bytes (~s)\033[0m.", [Conf#config.log_file_max_size, ems_util:bytes_to_human_size(Conf#config.log_file_max_size)]),
			...
			ems_logger:info("  \033[0;32mjava_service_user_notify_enabled\033[0m: \033[01;34m~p\033[0m.", [Conf#config.java_service_user_notify_enabled]),
			...
			ems_logger:info("  \033[0;32mhttp_max_content_length\033[0m: \033[01;34m~p bytes (~s)\033[0m.", [Conf#config.http_max_content_length, ems_util:bytes_to_human_size(Conf#config.http_max_content_length)]),
